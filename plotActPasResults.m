...
%% Single neuron figures/analyses
    ...
    for key_idx = 1:height(keyTable)
        ...
        vaf_modelsep_neuronsep = ...
            1 - ...
            sum((neuron_eval_select.S1_FR_indiv_sep-neuron_eval_select.glm_handelbow_model_indiv_sep).^2)/...
            sum((neuron_eval_select.S1_FR_indiv_sep-mean(neuron_eval_select.S1_FR_indiv_sep)).^2);
        corr_modelsep_neuronsep = corr(neuron_eval_select.S1_FR_indiv_sep,neuron_eval_select.glm_handelbow_model_indiv_sep,'rows','complete');
        corr_pr2_neuronsep = corr(neuron_eval_select.S1_FR_indiv_sep,neuron_eval_select.glm_handelbow_model_eval,'rows','complete');
        corr_actpr2_neuronsep = corr(neuron_eval_select.S1_FR_indiv_sep,neuron_eval_select.glm_handelbow_model_act_eval,'rows','complete');
        corr_paspr2_neuronsep = corr(neuron_eval_select.S1_FR_indiv_sep,neuron_eval_select.glm_handelbow_model_pas_eval,'rows','complete');

        % put together in table
        corr_cell{key_idx} = table(...
            vaf_modelsep_neuronsep,...
